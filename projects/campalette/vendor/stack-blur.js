...
export let image         = processImage;
export let canvasRGBA    = processCanvasRGBA;
export let canvasRGB     = processCanvasRGB;
export let imageDataRGBA = processImageDataRGBA;
export let imageDataRGB  = processImageDataRGB;
