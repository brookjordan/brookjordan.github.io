var defaultVerbs = [
  ...
  ` tripped on $subject`,
  ` fell over`,
  ` triple backflipped over $object`,
  ` raced $subject`,
  ` tied $subject up`,
  ` hurled $place`,
  ` dove deep $place`,
  ` switched $object with $object`,
  ...
  ` never could have afforded $object`,
  ` agreed $subject $verb`,
  ` alit $place`,
  ...
  ` called $person`,
  ` would never keep $object`,
  ` decided to provide $subject with $object`,
  ...
  ` wrote on the back of $subject`,
  ` ran $place`,
  ` found out he could set $subject to silent`,
  ...
  ` offered $object to $subject but $they $verb`,
  ` was offered $object`,
  ...
  ` added $object to $object resulting in the time that $subject $verb`,
  ` morphed into $object`,
  ` changed in front of $subject`,
  ` changed $subject into $object`,
  ` fell over`,
  ...
  ` said $they would would never speak again`,
  ...
  ` bought $object, $object and $object $place`,
  ` developed a new type of $object`,
  ` agreed it was awesome that time $person $verb`,
  ` should have opened $object for $subject`,
  ` couldn't reach $subject`,
  ` reached over $subject`,
  ` built some kind of $object`,
